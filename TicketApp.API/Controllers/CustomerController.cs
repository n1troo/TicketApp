...
/// <summary>
///     Endpoint used to interact with the customers
/// </summary>
...
{
    private readonly ICustomerRepository _authorRepository;
    ...
    public async Task<IActionResult> GetCustomers()
    {
        ...
        try
        {
            ...
            var customers = await _authorRepository.FindAll();
    ...
    /// </summary>
    /// <param name="id"></param>
    /// <returns>An Customer's record</returns>
    [HttpGet("{id}")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    ...
    public async Task<IActionResult> GetAuthor(int id)
    {
        ...
        try
        {
            ...
            var response = _mapper.Map<CustomerDTO>(author);
    ...
    public async Task<IActionResult> Create([FromBody] CustomerCreateDTO customerDTO)
    {
        ...
        try
        {
            ...
            var author = _mapper.Map<Customer>(customerDTO);
